...
class ClickMe extends Component<ClickMeProps, ClickMeState> {
  ...
  // 1-1 최초로 컴포넌트가 랜더링되고 반영될때 호출되는 함수들
  ...
  // 1-3
  render(){
    console.log('1-3/2-3 render가 호출됨');
  ...
  componentDidMount() {
    ...
    console.log('1-4 componentDidMount 호출');
    console.log(document.querySelector('button')?.textContent);
  }
